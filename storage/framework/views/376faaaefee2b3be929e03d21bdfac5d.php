...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('register')); ?>" class="ms-3 inline-block px-4 py-2 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
...
<?php endif; ?>
<?php /**PATH C:\Users\vgdsn\OneDrive\Área de Trabalho\Projeto-Vaga-Voch-main\Projeto-Vaga-Voch-main\resources\views/auth/login.blade.php ENDPATH**/ ?>